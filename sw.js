...
workbox.routing.registerRoute(new RegExp('https://cdn.jsdelivr.net/npm/workbox-cdn@4.3.1/workbox'), new workbox.strategies.CacheFirst ({"cacheableResponse":{"statuses":[0,200]}}), 'GET')
